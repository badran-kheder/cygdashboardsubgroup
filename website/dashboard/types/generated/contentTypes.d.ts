...
export interface ApiHeroSectionHeroSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    buttons: Schema.Attribute.Component<'buttons.hero-button', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    showFooter: Schema.Attribute.Boolean;
...
export interface ApiIndustryIndustry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    href: Schema.Attribute.String & Schema.Attribute.DefaultTo<'/services'>;
...
export interface ApiPageHeroSectionPageHeroSection
  extends Struct.CollectionTypeSchema {
  collectionName: 'page_hero_sections';
  info: {
    displayName: 'Page Hero Section';
    pluralName: 'page-hero-sections';
    singularName: 'page-hero-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    HeroButton: Schema.Attribute.Component<'hero-buttons.hero-button', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::page-hero-section.page-hero-section'
    > &
      Schema.Attribute.Private;
...
export interface ApiPageServiceSectionPageServiceSection
  extends Struct.CollectionTypeSchema {
  collectionName: 'page_service_sections';
  info: {
    displayName: 'Page Service Section';
    pluralName: 'page-service-sections';
    singularName: 'page-service-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    clickableCards: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
