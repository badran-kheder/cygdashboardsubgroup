...
export default function Hero({
  ...
  const shouldUseRadialGradient = isAboutPage || isServicesPage || isContactPage
  ...
  return (
    ...
    >
      ...
      {/* Main Hero Content */}
      <div className={`relative z-10 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-24 max-w-7xl mx-auto ${getContentMargin()}`}>
        <div className={`flex flex-col ${getTextAlignment()}`}>
          ...
          <p className={`hero-description mb-4 sm:mb-6 md:mb-8 transition-opacity duration-1000 ${isTypingComplete ? 'opacity-100' : 'opacity-0'}`}>
            {description}
          </p>
            ...
            <div className={`flex flex-col sm:flex-row gap-3 sm:gap-4 ${getButtonAlignment()} items-start transition-opacity duration-1000 delay-500 ${isTypingComplete ? 'opacity-100' : 'opacity-0'}`}>
              ...
              <Link
                ...
                className={`hero-button inline-flex items-center font-semibold hover:scale-105 ${
                  button.variant === 'primary' ? 'btn-primary hero-button-primary' : 'hero-button-secondary'
                }`}
                style={
                  button.variant === 'primary'
                    ? {
                        ...
                        padding: "clamp(12px, 2vw, 20px) clamp(32px, 5vw, 64px)",
                        gap: "0px",
                        borderRadius: "80px",
      ...
      {showFooter && (
        ...
        >
          <div className="mx-auto flex flex-col h-full sm:flex-row justify-between items-center">
            ...
            <div className="flex-1 mb-2 sm:mb-0 overflow-hidden">
              <div className="flex items-center space-x-4 sm:space-x-8 animate-scroll">
                ...
                {footerLogos.map((logo, index) => (
                  <div key={`first-${index}`} className="flex items-center space-x-1 sm:space-x-2 whitespace-nowrap">
                    <div
                ...
                {footerLogos.map((logo, index) => (
                  <div key={`second-${index}`} className="flex items-center space-x-1 sm:space-x-2 whitespace-nowrap">
                    <div
                      className="text-white font-bold text-sm sm:text-base md:text-lg"
                      style={{ fontFamily: "Helvetica, Arial, sans-serif" }}
                    >
            ...
            <Link
              href={reviewsLink}
              className="h-full inline-flex items-center justify-center font-semibold hover:scale-105 text-xs sm:text-sm md:text-base"
              style={{
