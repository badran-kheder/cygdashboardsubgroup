      ...
      >
        ...
        >
          ...
          <Link href="/" className="flex items-center">
            <div className={`bg-primary-200 rounded-lg flex items-center justify-center mr-3 transition-all duration-300 ${
              isScrolled ? 'w-10 h-10' : 'w-12 h-12'
            }`}>
              <span className={`text-primary-900 font-bold transition-all duration-300 ${
            ...
            <div className="text-primary-200 font-semibold">
              ...
              <div className={`text-primary-300 leading-tight transition-all duration-300 ${
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link href="/" className="text-primary-200 hover:text-primary-500 transition-colors duration-200">
              Home
            </Link>
            ...
            <Link href="/about" className="text-primary-200 hover:text-primary-500 transition-colors duration-200">
              About Us
            </Link>
            <Link href="/clients" className="text-primary-200 hover:text-primary-500 transition-colors duration-200">
              Clients
            </Link>
            <Link href="/contact" className="text-primary-200 hover:text-primary-500 transition-colors duration-200">
              Contact Us
            </Link>
          </nav>
